...
import { getMigratableEffectChanges } from "./effect-change-collection.mjs";
 ...
 */
function isActiveEffectSource(objectData) {
	if ( objectData?.documentName === "ActiveEffect" ) return true;
	return Boolean(getMigratableEffectChanges(objectData));
}
...
export function applyImagePathMigration(objectData, updateData={}, options={}) {
	...
	const isEffect = isActiveEffectSource(objectData);
